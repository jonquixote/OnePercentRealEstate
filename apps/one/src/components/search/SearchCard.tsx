    ...
    >
      ...
      >
        ...
        <button
          ...
          className={`absolute right-3 top-3 rounded-full border px-2.5 py-1 text-[11px] font-semibold backdrop-blur transition-opacity ${isSold ? 'opacity-40 group-hover:opacity-70' : inCompare ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
          style={
            inCompare
