...
# DATABASE_URL points at Postgres DIRECT (:5432). The PgBouncer cutover to :6432
# only happens once oper-pgbouncer is actually deployed + running (db-perf plan
# Task 5) — pointing here before that broke the app (db down, 2026-07-24).
