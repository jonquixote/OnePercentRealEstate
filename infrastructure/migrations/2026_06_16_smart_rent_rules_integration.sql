-- 2026_06_16_smart_rent_rules_integration.sql
-- Update calculate_smart_rent to integrate with property_type_rules via is_rentable helper function.

BEGIN;

CREATE OR REPLACE FUNCTION public.calculate_smart_rent(
    p_lat NUMERIC,
    p_lon NUMERIC,
    p_beds INT,
...
BEGIN
    ...
    -- Call the dynamic is_rentable function that queries property_type_rules
    IF NOT public.is_rentable(p_property_type) THEN
